...
class BaseAdapter {
   ...
   */
  getGeneratedHeader() {
    return `# Generated by Xavier v1.0.0
# Do not edit directly - regenerate with: npm run xavier:generate
...
`;
   ...
   * This teaches the AI how to use Xavier by reading ai-tools/
   */
  generateReferenceContent(config, title = 'Xavier AI Framework') {
...
Xavier is your AI development team with specialized agents working in parallel.
...
Xavier uses wave-based parallel execution:
